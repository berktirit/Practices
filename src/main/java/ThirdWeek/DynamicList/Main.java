...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Son indeks : " + list.lastIndexOf(20));

        Object[] array = list.toArray();
        System.out.println("Object dizisinin ilk elemanı : " + array[0]);

        DynamicArray<Integer> subListExample = list.subList(0, 3);
        System.out.println("Alt liste : " + subListExample.toString());

        System.out.println("Listemde 20 değeri : " + list.contains(20));
        System.out.println("Listemde 120 değeri : " + list.contains(120));

        list.clear();
        System.out.println("Liste temizlendi : " + list.toString());
    }
}